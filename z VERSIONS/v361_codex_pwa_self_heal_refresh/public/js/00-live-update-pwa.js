// Shelfd split runtime guard v361-pwa-self-heal-refresh.
...
window.__shelfdSplitChunkVersion = '361-pwa-self-heal-refresh';
...
(function initScreenListDeployAutoRefresh() {
  ...
  const LIVE_UPDATE_LOGO_SRC = '/live_update_splash_logo.png?v=361-pwa-self-heal-refresh';
  const LIVE_UPDATE_MESSAGE = 'the developer has just sent out a live update, please wait for refresh';
  const PWA_CACHE_RESET_KEY = 'shelfd-pwa-cache-reset-v361';

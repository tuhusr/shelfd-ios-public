/* v963: Movies-only matchup game keeps tier results separate and avoids full-library eager poster spikes. */
(function initShelfdMovieRatingDuel() {
  if (window.__shelfdMovieRatingDuelV963) return;
  window.__shelfdMovieRatingDuelV963 = true;
  ...
  function getSavedMovieTierList() {
    return normalizeSavedTierList(userProfile?.movieRatingTierList);
  }

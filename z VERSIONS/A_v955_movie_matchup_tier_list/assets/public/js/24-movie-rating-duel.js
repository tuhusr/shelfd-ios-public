/* v955: Movies-only matchup game saves a separate ongoing tier list after each run. */
(function initShelfdMovieRatingDuel() {
  if (window.__shelfdMovieRatingDuelV955) return;
  window.__shelfdMovieRatingDuelV955 = true;

/* v976: Multi-media tier list game with S/A/B/C/D/E/F tier structure. */
(function initShelfdMovieRatingDuel() {
  if (window.__shelfdTierListGameV976) return;
  window.__shelfdTierListGameV976 = true;
  ...
  async function finishMovieRatingDuel(resultBand, defeatedBand = 0, anchorItem = null, options = {}) {
    ...
    renderResult(finalBand, defeatedBand, tierList, options || null);
    try {

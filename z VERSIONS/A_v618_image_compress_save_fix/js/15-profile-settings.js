...
async function saveProfileFavoritesAuto(message = 'saved', options = {}) {
  ...
  try {
    ...
    /* v618: Make failure impossible to miss — a 4s toast at high priority. */
    if (typeof showToast === 'function') showToast('Save failed — please try again', { duration: 4000, type: 'error' });
    return false;
  }
}

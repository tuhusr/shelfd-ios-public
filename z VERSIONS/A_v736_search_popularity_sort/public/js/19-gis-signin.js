...
(function() {
  ...
  function getButtonWidth() {
    /* v644: render at GIS's max width (400px). The wrapper has a transform:
       scale(1.18) so visually the button reads as ~470px — which combined
       with the golden halo halos around it makes a proper primary-CTA
       presence. */
    return 400;
  }

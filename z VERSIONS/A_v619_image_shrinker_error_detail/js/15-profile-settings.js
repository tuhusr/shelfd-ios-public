...
async function saveProfileFavoritesAuto(message = 'saved', options = {}) {
  ...
  try {
    /* v619: instrument document size so we can confirm it's under the cap. */
    try {
    ...
    /* v619: surface the actual Firestore error code/message in the toast so we
       can stop guessing what's blocking the save. */

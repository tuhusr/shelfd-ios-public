// Shelfd split runtime guard v362-pwa-edge-no-store.
...
window.__shelfdSplitChunkVersion = '362-pwa-edge-no-store';
...
(function initScreenListDeployAutoRefresh() {
  ...
  const PWA_CACHE_RESET_KEY = 'shelfd-pwa-cache-reset-v362';

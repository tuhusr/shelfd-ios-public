  ...
  selectedArea.innerHTML = `
    <div class="tmdb-selected add-shelf-selected-card">
      ...
      <div class="tmdb-selected-info add-shelf-selected-info">
        <div class="add-shelf-selected-kicker">Selected</div>
...
function showModalStatusPicker() {
  ...
  setAddShelfModalStep('status');
  picker.innerHTML = `
    <div class="modal-status-head">
      <div class="modal-status-label">Choose shelf</div>
      <div class="modal-status-subtitle">Pick where this title belongs.</div>
    </div>
...
function renderModalAddConfirmation(status, backHandler = showModalStatusPicker) {
  ...
  setAddShelfModalStep('confirm');
  picker.innerHTML = `
    <div class="modal-status-head">
      <div class="modal-status-label">Review</div>
      <div class="modal-status-subtitle">Confirm the destination before saving.</div>
    </div>
...
function showModalRatingPrompt(selectedRating = pendingModalRatingSelection) {
  ...
  const stars = typeof buildStandaloneRatingStarsMarkup === 'function'
    ...
    : '';
  setAddShelfModalStep('rating');
  picker.innerHTML = `
    <div class="modal-status-head">
      <div class="modal-status-label">Rating</div>
      <div class="modal-status-subtitle">Set it once. The next screen is only a summary.</div>
    </div>
    <div class="discover-rating-prompt add-shelf-rating-prompt">
      <div class="modal-status-confirm-title">Set your rating</div>
      <div class="add-shelf-confirm-readout">${escHtml(selectedItem.title || 'This title')}</div>
      <div class="discover-add-desc">Choose a rating or skip it for now.</div>
      ${stars}
      <div class="modal-status-confirm-actions">

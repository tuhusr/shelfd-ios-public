...
function shelfdEnterSeasonFocusMode(itemId, sNum, epScroll, seasonBlock) {
  ...
  // ep-scroll before we lock overflow-y. (The smooth scroll already placed it
  // there, this is a micro-correction for any sub-pixel remainder.)
...
function shelfdExitSeasonFocusMode(itemId) {
  ...
  // Scroll back to top of the season list so all seasons are visible on reopen.

...
function renderMyListSettingsInner() {
  ...
  return `
    ...
    <div class="mylist-settings-import-box">
      ...
      <div class="mylist-settings-row">
        <span class="mylist-settings-row-label">Rate by Matchups</span>
        <button type="button" class="mylist-settings-action-btn" onclick="event.stopPropagation();closeMyListSettingsModal();setTimeout(() => openMovieRatingDuelLauncher(),180)">Play</button>
      </div>
    </div>

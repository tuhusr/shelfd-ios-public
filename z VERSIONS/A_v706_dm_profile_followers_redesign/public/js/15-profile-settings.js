  ...
  modal.innerHTML = `
    <div class="profile-social-sheet-v2">
      ...
      <div class="profile-social-list profile-social-body-v2">
        <div style="color:rgba(167,139,250,0.52);font-size:13px;text-align:center;padding:36px 0;font-family:'DM Sans',sans-serif">
          Loading people…
        </div>
      </div>
    </div>`;
  ...
  if (!users.length) {
    list.innerHTML = `
      <div style="display:flex;flex-direction:column;align-items:center;padding:52px 20px;gap:12px;
                  color:rgba(167,139,250,0.45);text-align:center;font-family:'DM Sans',sans-serif">

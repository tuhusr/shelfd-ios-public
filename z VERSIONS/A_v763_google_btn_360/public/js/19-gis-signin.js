...
(function() {
  ...
  function getButtonWidth() {
    /* v763: 360px to visually match the .landing-profile-cta width above
       (`min(360px, 92vw)`). Safer than the 280 we tried in v754 that
       caused empty iframe issues. The v762 safety net (force-show legacy
       button if iframe stays 0-height after 3s) stays in place as a
       backup if 360 also fails on some device. */
    return 360;
  }

...
function renderActivityUniversalRating(ratingValue = 0) {
  ...
  if (!rating) return '';
  /* v553: simplified rating chip — single filled star + numeric score
     (e.g. "★ 8") instead of five stars + "/10". Cleaner visual on the
     compact activity feed. */
  const score = formatActivityRatingScore(rating);
  return `<div class="sl-activity-rating sl-activity-rating-compact" aria-label="Rating ${escAttr(score)} out of 10">

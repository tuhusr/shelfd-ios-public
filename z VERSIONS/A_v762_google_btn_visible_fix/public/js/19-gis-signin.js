...
(function() {
  ...
  function getButtonWidth() {
    /* v762: restored to 400 (GIS native max). 280 was causing the GIS
       iframe to render empty / zero-height on some devices, leaving
       users with NO sign-in button visible. 400 is Google's tested
       maximum and is guaranteed to render. */
    return 400;
  }

...
async function loadDiscover(force = false) {
  ...
  try {
    ...
    /* v571: combined "Movies & TV" hub. One set of sections, each fetching
       movie + TV items together. Reuses the existing TV grid IDs as the
       canonical destinations; the movie-specific grid IDs (kept for the
       In Theaters row + so historical references don't break) are only
       populated by the few movie-only sections. */
    const sections = [
      {
      ...
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:mixed-date-new-releases:${DISCOVER_RANKING_CACHE_VERSION}:${discoverNewReleaseRange}:${DISCOVER_RELEASE_REGION}:all`,
          fetcher: () => fetchNewReleasesByDate(discoverNewReleaseRange, DISCOVER_LIMIT, DISCOVER_PAGE_COUNT, 'mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-new-releases-grid'),
          force
        })
      },
      {
      ...
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:mixed-years-best:${DISCOVER_RANKING_CACHE_VERSION}`,
          fetcher: () => fetchAndRankThisYearsBest('mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-years-best-grid'),
          force
        })
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:mixed-popular:${DISCOVER_RANKING_CACHE_VERSION}`,
          fetcher: () => fetchDiscoverPopularMedia('mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-popular-grid'),
          force
        })
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:mixed-top-rated:${DISCOVER_RANKING_CACHE_VERSION}`,
          fetcher: () => fetchDiscoverTopRatedMedia('mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-top-rated-grid'),
          force
        })
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:tmdb-weekly-trending-mixed:${DISCOVER_RANKING_CACHE_VERSION}`,
          fetcher: () => fetchTmdbWeeklyTrendingMedia('mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-trending-grid'),
          force
        })
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:mixed-anticipated:${DISCOVER_RANKING_CACHE_VERSION}`,
          fetcher: () => fetchAndRankAnticipated(DISCOVER_LIMIT, DISCOVER_PAGE_COUNT, 'mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-anticipated-grid'),
          force
        })
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:mixed-date-releasing-soon:${DISCOVER_RANKING_CACHE_VERSION}`,
          fetcher: () => fetchReleasingSoonByDate(DISCOVER_LIMIT, DISCOVER_PAGE_COUNT, 'mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-releasing-soon-grid'),
          force
        })
      },
      {
        ...
        run: () => renderDiscoverCachedRow({
          cacheKey: `media:mixed-hidden-gems:${DISCOVER_RANKING_CACHE_VERSION}`,
          fetcher: () => fetchAndRankHiddenGems('mixed'),
          render: items => renderRankedDiscoverCards('mixed', items, 'discover-tv-hidden-gems-grid'),
          force
        })
      }
    ];

...
async function submitModal(status) {
  ...
  activeTab = status;
  render();
  return { ok: true, message: `Added to ${getAddShelfStatusLabel(status, targetSection)}` };
}

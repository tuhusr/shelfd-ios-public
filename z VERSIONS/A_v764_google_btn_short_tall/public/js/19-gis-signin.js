...
(function() {
  ...
  function getButtonWidth() {
    /* v764: 280px wide per user request. The v762 safety net (force-show
       legacy button if iframe stays 0-height after 3s) is in place if
       280 happens to render empty on any device. */
    return 280;
  }

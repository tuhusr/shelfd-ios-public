...
function findAddShelfModalScrollHost(target) {
  ...
  return target.closest('#modal .add-shelf-step-scroll, #modal #tmdb-results, #modal .shelf-filter-pills');
}
...
function installAddShelfModalTouchGuard() {
  ...
  const onTouchMove = event => {
    ...
    if (scrollHost.classList && scrollHost.classList.contains('shelf-filter-pills')) {

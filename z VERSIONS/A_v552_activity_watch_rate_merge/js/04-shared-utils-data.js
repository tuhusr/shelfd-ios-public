...
function normalizeThemeMode(value) {
  // v482: 'Default Theme' option removed from settings; renamed True Dark
  // to 'Default Theme'. Map everything that isn't 'light' to 'true-dark'
  // so existing users with saved 'default' seamlessly get the new default
  // look (grey #A9A9A9 background) without losing their checked radio.
  return value === 'light' ? 'light' : 'true-dark';
}

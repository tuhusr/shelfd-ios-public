    ...
    try {
      ...
      try {
        await userRef.set({
          ...
          /* v808/v812: write the current Default Theme on the very first
             user-doc write so a brand-new account never lands on legacy
             theme state, even for the brief moment before saveUserProfile
             runs. v812 corrects the value: 'default' (BASE CSS, lavender/
             charcoal Shelfd UI) — NOT 'true-dark' which is the legacy
             pitch-black True Dark theme. */
          themeMode: 'default',

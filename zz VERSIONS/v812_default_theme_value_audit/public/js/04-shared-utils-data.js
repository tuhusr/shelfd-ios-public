...
/* v812 — Theme value mapping (audited):
   ───────────────────────────────────────────────────────────────────────
     'default'   → no body class. BASE CSS is the current Shelfd look:
                   lavender/purple accents on charcoal.
                   THIS IS THE CURRENT DEFAULT THEME / "Standard Shelfd look".
     'true-dark' → adds body.true-dark-mode. Activates the LEGACY pitch-
                   black/grey True Dark CSS (page #0E0E0E, cards #272727,
                   neutral-grey overrides on Discover/My Lists/Activity).
                   This is the OLD True Dark theme; not the current default.
   ...
   v808 prior assumption that 'true-dark' was the "current default" was
   WRONG — the v482 code comment claiming "True Dark renamed to Default
   Theme" was a label change only; the CSS still applies the old True
   Dark visual. Audit done in v812. */
...
/* v808/v812 — Step 1: force every user into the current Default Theme.
   Anything that isn't literally 'default' (true-dark / light / cream /
   null / undefined / invalid / legacy) coerces to 'default'. To re-enable
   other themes later, replace this body with `return normalizeThemeMode(value);` */

...
const DISCOVER_HERO_TRAILER_EXPAND_TRANSITION = 'left 600ms cubic-bezier(0.16, 1, 0.3, 1), top 600ms cubic-bezier(0.16, 1, 0.3, 1), width 600ms cubic-bezier(0.16, 1, 0.3, 1), height 600ms cubic-bezier(0.16, 1, 0.3, 1), border-radius 600ms cubic-bezier(0.16, 1, 0.3, 1)';
...
function applyDiscoverHeroTrailerExpansionProgress(overlay = document.getElementById('discover-media-profile'), rawProgress = 0) {
  ...
  overlay.style.setProperty('--media-profile-trailer-page-y', `${(viewport.height * 0.46 * progress).toFixed(2)}px`);
  return progress;
}

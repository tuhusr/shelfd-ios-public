    ...
    try {
      ...
      try {
        await userRef.set({
          ...
          /* v808: write the current Default Theme on the very first user-
             doc write so a brand-new account never lands on the legacy
             purple-gradient state, even for the brief moment before

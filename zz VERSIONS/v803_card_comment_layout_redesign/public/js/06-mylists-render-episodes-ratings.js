...
function buildCardCommentBodyHtml(item) {
  ...
  if (isOwner) {
    return '<div class="card-comment-body card-comment-body--owner" onclick="event.stopPropagation();openCardCommentComposer(\'' + itemIdAttr + '\')" tabindex="0" role="button" aria-label="Edit your comment" data-card-comment-id="' + itemIdAttr + '"><span class="card-comment-body-text">' + escHtml(text) + '</span></div>';
  }

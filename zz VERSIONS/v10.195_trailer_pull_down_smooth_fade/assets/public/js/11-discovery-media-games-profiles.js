...
function resetDiscoverHeroTrailerExpansionState(overlay = document.getElementById('discover-media-profile')) {
  ...
  overlay?.classList?.remove('media-profile-trailer-expanding', 'media-profile-trailer-fullscreen', 'media-profile-trailer-collapsing', 'media-profile-trailer-gesture');
...
function applyDiscoverHeroTrailerExpansionProgress(overlay = document.getElementById('discover-media-profile'), rawProgress = 0) {
  ...
  overlay.style.setProperty('--media-profile-trailer-page-y', `${(42 * fadeProgress).toFixed(2)}px`);
  return progress;
}

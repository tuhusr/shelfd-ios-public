...
function resetDiscoverHeroTrailerExpansionState(overlay = document.getElementById('discover-media-profile')) {
  ...
  overlay?.classList?.remove('media-profile-trailer-expanding', 'media-profile-trailer-fullscreen', 'media-profile-trailer-collapsing', 'media-profile-trailer-gesture', 'media-profile-trailer-animating', 'media-profile-trailer-controls-hidden', 'media-profile-trailer-aspect-preserve');

...
const DISCOVER_HERO_TRAILER_EXPAND_TRANSITION = 'left 260ms cubic-bezier(0.2, 1, 0.25, 1), top 260ms cubic-bezier(0.2, 1, 0.25, 1), width 260ms cubic-bezier(0.2, 1, 0.25, 1), height 260ms cubic-bezier(0.2, 1, 0.25, 1), border-radius 260ms cubic-bezier(0.2, 1, 0.25, 1)';
...
function applyDiscoverHeroTrailerExpansionProgress(overlay = document.getElementById('discover-media-profile'), rawProgress = 0) {
  ...
  preview.style.setProperty('--media-profile-trailer-content-opacity', `${Math.max(0, 1 - progress * 1.15).toFixed(3)}`);

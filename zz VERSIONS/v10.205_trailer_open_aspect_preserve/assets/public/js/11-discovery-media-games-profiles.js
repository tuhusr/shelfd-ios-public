...
function resetDiscoverHeroTrailerExpansionState(overlay = document.getElementById('discover-media-profile')) {
  ...
  overlay?.classList?.remove('media-profile-trailer-expanding', 'media-profile-trailer-fullscreen', 'media-profile-trailer-collapsing', 'media-profile-trailer-gesture', 'media-profile-trailer-animating', 'media-profile-trailer-controls-hidden', 'media-profile-trailer-opening-aspect');
...
function applyDiscoverHeroTrailerExpansionProgress(overlay = document.getElementById('discover-media-profile'), rawProgress = 0) {
  ...
  if (overlay.classList.contains('media-profile-trailer-opening-aspect')) {
...
function finishDiscoverHeroTrailerExpansion(overlay = document.getElementById('discover-media-profile')) {
  ...
  cancelDiscoverHeroTrailerProgressAnimation();
  overlay.classList.remove('media-profile-trailer-expanding', 'media-profile-trailer-collapsing', 'media-profile-trailer-gesture', 'media-profile-trailer-animating', 'media-profile-trailer-opening-aspect');
...
function expandDiscoverHeroTrailerPreview(overlay = document.getElementById('discover-media-profile'), options = {}) {
  ...
  overlay?.classList?.add('media-profile-trailer-opening-aspect');
...
function collapseDiscoverHeroTrailerPreview(overlay = document.getElementById('discover-media-profile'), options = {}) {
  ...
  overlay.classList.remove('media-profile-trailer-fullscreen', 'media-profile-trailer-expanding', 'media-profile-trailer-opening-aspect');
  overlay.classList.add('media-profile-trailer-collapsing');
...
function bindDiscoverMediaProfileSwipeBack(overlay) {
  ...
  const armGesture = (mode) => {
    ...
    if (mode === 'trailer-expand' || mode === 'trailer-collapse') {
      ...
      overlay.classList.toggle('media-profile-trailer-opening-aspect', mode === 'trailer-expand');

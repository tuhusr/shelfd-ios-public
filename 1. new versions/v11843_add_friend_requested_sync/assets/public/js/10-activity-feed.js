...
function buildActivityFeedHeaderHTML(heading = 'Activity Feed', options = {}) {
  ...
  if (showSectionNav) {
    ...
    actionButtons.push(`<button type="button" class="activity-shared-watch-pill activity-feed-pill ${feedActive ? 'active' : 'secondary'}" aria-current="${feedActive ? 'true' : 'false'}" onclick="switchActivitySubTab('feed')">Friends Feed</button>`);

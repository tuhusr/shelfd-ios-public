...
function renderDirectMessageInboxLine2HTML(thread = {}) {
  ...
  if (unreadCount > 1) {
    return `<div class="dm-chat-line2"><span class="dm-chat-preview">${unreadCount} new messages</span><span class="dm-chat-time">${formatDirectMessageTime(timeMs)}</span></div>`;
  }

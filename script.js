// Shelfd source split v292-activity-card-smaller-text-halfstar-fix: compatibility script loader.
...
(function loadShelfdSplitScripts() {
  ...
  var files = ['/js/00-live-update-pwa.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/01-firebase-login-state.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/02-messages-e2ee.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/03-watch-together.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/04-shared-utils-data.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/05-app-state-preview-routes.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/06-mylists-render-episodes-ratings.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/07-add-shelf-import-search.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/08-discovery-state.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/09-direct-messages.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/10-activity-feed.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/11-discovery-media-games-profiles.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/12-patch-notes.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/13-discover-add-imports.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/14-navigation.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/15-profile-settings.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/16-friends-requests.js?v=292-activity-card-smaller-text-halfstar-fix', '/js/17-comments-auth-init.js?v=292-activity-card-smaller-text-halfstar-fix'];

...
(function () {
  ...
  /* v12.060: sharpened settle to feel responsive. Duration 360ms, easeOutCubic
     (cubic-bezier(0.215,0.61,0.355,1)) — starts fast then decelerates cleanly,
     matching native iOS page swipe feel. Previous 520ms easeOutQuad was too sluggish. */
  const SETTLE_MS = 360;              // commit / snap-back length
  const SETTLE_EASE = 'cubic-bezier(0.215, 0.61, 0.355, 1)'; // easeOutCubic — sharp deceleration
